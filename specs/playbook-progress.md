...
| 7 | `docs/playbook/08-deployment.md` | Done | 2026-02-26 | Full rewrite: pre-deployment checklist, Docker build + compose (copy-paste), Railway 7-step walkthrough (compose import, env vars, volumes, domain), network selection table, graceful shutdown, health check, Langfuse monitoring, update/redeploy flow. Fly.io section removed. |
...
| # | File | Status | Date | Notes |
|---|------|--------|------|-------|
| 8 | `docs/playbook/guides/building-and-publishing-skills.md` | Not started | | NEW. Depends on ai-skills repo flow. |
| 9 | `docs/playbook/reference/skills-registry-api.md` | Not started | | NEW. Capsules API reference. |
| 10 | `docs/playbook/reference/sandbox-api.md` | Not started | | NEW. AI Sandbox API reference. |
...
| 13 | `docs/playbook/guides/memory-engine.md` | Not started | | Partial content exists. |
| 14 | `docs/playbook/guides/knowledge-store.md` | Not started | | Skeleton. |
| 15 | `docs/playbook/guides/payments-and-claims.md` | Not started | | Skeleton. |
| 16 | `docs/playbook/guides/events-streaming.md` | Not started | | Skeleton. |
| 17 | `docs/playbook/guides/slack-integration.md` | Not started | | Skeleton. |
| 18 | `docs/playbook/guides/client-sdk.md` | Not started | | Skeleton. |
| 19 | `docs/playbook/guides/matrix-deep-dive.md` | Not started | | Skeleton. |
...
1. **Deployment platform** — ✅ Resolved: Railway. Ch08 updated with full Railway walkthrough, Fly.io section removed. (2026-02-26)
2. **ai-skills contribution flow** — Is it PR-based to `ixoworld/ai-skills`? Or CLI command? Needed for guide #8.

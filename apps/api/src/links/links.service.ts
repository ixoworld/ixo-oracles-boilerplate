...
import { type Link } from '@ixo/api/links/entities/link.entity';

import { type CreateLinkDto } from '@ixo/api/links/dto/create-link.dto';
import { type UpdateLinkDto } from '@ixo/api/links/dto/update-link.dto';

...
export enum IxoSwapPriceHistoriesOrderBy {
  ...
  Token_2VolumeAsc = 'TOKEN_2_VOLUME_ASC',
  Token_2VolumeDesc = 'TOKEN_2_VOLUME_DESC',
  Token_1155PriceAsc = 'TOKEN_1155_PRICE_ASC',
  Token_1155PriceDesc = 'TOKEN_1155_PRICE_DESC',
  Token_1155VolumeAsc = 'TOKEN_1155_VOLUME_ASC',
  Token_1155VolumeDesc = 'TOKEN_1155_VOLUME_DESC',
}
...
export type IxoSwapPriceHistory = Node & {
  ...
  token2Volume: Scalars['BigFloat']['output'];
  token1155Price: Scalars['BigFloat']['output'];
  token1155Volume: Scalars['BigFloat']['output'];
};
...
export type IxoSwapPriceHistoryCondition = {
  ...
  token2Volume: InputMaybe<Scalars['BigFloat']['input']>;
  ...
  token1155Volume: InputMaybe<Scalars['BigFloat']['input']>;
};
...
export type IxoSwapPriceHistoryFilter = {
  ...
  token2Volume: InputMaybe<BigFloatFilter>;
  ...
  token1155Volume: InputMaybe<BigFloatFilter>;
};
...
export type Query = Node & {
  ...
  smartAccountAuthenticator: Maybe<SmartAccountAuthenticator>;
  /** Reads a single `SmartAccountAuthenticator` using its globally unique `ID`. */
  smartAccountAuthenticatorByNodeId: Maybe<SmartAccountAuthenticator>;
  /** Reads and enables pagination through a set of `SmartAccountAuthenticator`. */
  smartAccountAuthenticators: Maybe<SmartAccountAuthenticatorsConnection>;
  token: Maybe<Token>;
...
/** The root query type which gives access points into the data universe. */
export type QuerySmartAccountAuthenticatorArgs = {
  id: Scalars['String']['input'];
};

/** The root query type which gives access points into the data universe. */
export type QuerySmartAccountAuthenticatorByNodeIdArgs = {
  nodeId: Scalars['ID']['input'];
};

/** The root query type which gives access points into the data universe. */
export type QuerySmartAccountAuthenticatorsArgs = {
  after: InputMaybe<Scalars['Cursor']['input']>;
  before: InputMaybe<Scalars['Cursor']['input']>;
  condition: InputMaybe<SmartAccountAuthenticatorCondition>;
  filter: InputMaybe<SmartAccountAuthenticatorFilter>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
  offset: InputMaybe<Scalars['Int']['input']>;
  orderBy?: InputMaybe<Array<SmartAccountAuthenticatorsOrderBy>>;
};
...
export type SmartAccountAuthenticator = Node & {
  __typename?: 'SmartAccountAuthenticator';
  address: Scalars['String']['output'];
 ...
 */
export type SmartAccountAuthenticatorCondition = {
  /** Checks for equality with the object’s `address` field. */
  address: InputMaybe<Scalars['String']['input']>;
...
export type SmartAccountAuthenticatorFilter = {
  /** Filter by the object’s `address` field. */
  address: InputMaybe<StringFilter>;
  /** Checks for all expressions in this list. */
  and: InputMaybe<Array<SmartAccountAuthenticatorFilter>>;
  ...
  /** Negates the expression. */
  not: InputMaybe<SmartAccountAuthenticatorFilter>;
  /** Checks for any expressions in this list. */
  or: InputMaybe<Array<SmartAccountAuthenticatorFilter>>;
  /** Filter by the object’s `type` field. */
  type: InputMaybe<StringFilter>;
};

/** A connection to a list of `SmartAccountAuthenticator` values. */
export type SmartAccountAuthenticatorsConnection = {
  __typename?: 'SmartAccountAuthenticatorsConnection';
  /** A list of edges which contains the `SmartAccountAuthenticator` and cursor to aid in pagination. */
  edges: Array<SmartAccountAuthenticatorsEdge>;
  /** A list of `SmartAccountAuthenticator` objects. */
  nodes: Array<SmartAccountAuthenticator>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
...
export type SmartAccountAuthenticatorsEdge = {
  __typename?: 'SmartAccountAuthenticatorsEdge';
  /** A cursor for use in pagination. */
  cursor: Maybe<Scalars['Cursor']['output']>;
...
export enum SmartAccountAuthenticatorsOrderBy {
  AddressAsc = 'ADDRESS_ASC',
  AddressDesc = 'ADDRESS_DESC',
...
export type GetEntityByIdQuery = {
  __typename?: 'Query';
  entity: {
    __typename?: 'Entity';
    id: string;
...
export type GetEntityByTypeQueryVariables = Exact<{
  type: Scalars['String']['input'];
}>;

export type GetEntityByTypeQuery = {
  __typename?: 'Query';
  entities: {
    __typename?: 'EntitiesConnection';
    nodes: Array<{
...
export type GetEntitiesByOwnerAddressQueryVariables = Exact<{
  ownerAddress: Scalars['String']['input'];
}>;

export type GetEntitiesByOwnerAddressQuery = {
  __typename?: 'Query';
  entities: {
    __typename?: 'EntitiesConnection';
    nodes: Array<{
...
`;
export const GetEntityByIdDocument = gql`
...
`;
export const GetEntityByTypeDocument = gql`
  query GetEntityByType($type: String!) {
...
`;
export const GetEntitiesByOwnerAddressDocument = gql`
